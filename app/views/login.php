...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    <!-- the db is not getting image.. what could be the reason??  -->
    <form action="/blogs/?page=user/authenticate" method="POST" class="space-y-6">  
      <div>
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Not a member?
      <a href="/blogs/?page=user/signup" class="font-semibold text-indigo-600 hover:text-indigo-500">Sign Up for free</a>
    </p>
  </div>
</div>
